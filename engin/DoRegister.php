...
if(isset($_POST['display-name']) && isset($_POST['password']) && isset($_POST['email'])) {
    ...
    if ($rows > 0){
       ...
       mysqli_query($db,"INSERT INTO users_tbl(Usr_DisplayName,Usr_UserName,Usr_Password) VALUES('$display_name','$email','$password')") or die (mysqli_error($db));
